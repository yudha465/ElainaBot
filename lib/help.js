...
Contoh : *${prefix}tiktokstalk @ach.yud_5*

*[@username]* Diisi dengan Username yang valid tanpa tanda “[” dan “]”
Contoh : *${prefix}igstalk @ach.yud_5*

*[@username]* Diisi dengan Username yang valid tanpa tanda “[” dan “]”
Contoh : *${prefix}smulestalk @ach.yud_5*
...
Contoh : *${prefix}jadwalShalat Surabaya*
...
Contoh : *${prefix}googlesearch siapa itu WIKO*
...
╠➥ *NAME : WIKO BOT*
╠➥ *VERSION : 3.0*
╠➥ *GITHUB : github.com/yudha465*
╠➥ *TEAM : @Wibu Konglomerat*
║
╚═〘 WIKO BOT 〙
`
}
...
exports.info = info
const snk = () => {
    return `Syarat dan Ketentuan Bot *WIKO*
